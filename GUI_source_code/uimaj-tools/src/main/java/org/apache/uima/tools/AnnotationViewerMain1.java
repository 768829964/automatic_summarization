 ...
 *
 */
public class AnnotationViewerMain1 extends JFrame {
...
//				4, 4); // xPad, yPad
		...
		helpMenuItem.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				JOptionPane.showMessageDialog(AnnotationViewerMain1.this, HELP_MESSAGE,
	...
	public static void main(String[] args) {
		final AnnotationViewerMain1 frame = new AnnotationViewerMain1();
	...
	public void displayError(String aErrorString) {
		...
		JOptionPane.showMessageDialog(AnnotationViewerMain1.this, buf.toString(), "Error",
