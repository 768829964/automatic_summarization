...
public class BinaryRelation_Type extends Relation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.apache.ctakes.coreference.type.BinaryRelation");
  ...
  public int getArg1(int addr) {
      ...
      jcas.throwFeatMissing("arg1", "org.apache.ctakes.coreference.type.BinaryRelation");
  ...
  public int getArg2(int addr) {
      ...
      jcas.throwFeatMissing("arg2", "org.apache.ctakes.coreference.type.BinaryRelation");
  ...
  public BinaryRelation_Type(JCas jcas, Type casType) {
    ...
    casFeat_arg1 = jcas.getRequiredFeatureDE(casType, "arg1", "org.apache.ctakes.coreference.type.RelationArgument", featOkTst);
    casFeatCode_arg1  = (null == casFeat_arg1) ? JCas.INVALID_FEATURE_CODE : ((FeatureImpl)casFeat_arg1).getCode();

 
    casFeat_arg2 = jcas.getRequiredFeatureDE(casType, "arg2", "org.apache.ctakes.coreference.type.RelationArgument", featOkTst);
