 ...
 * @generated */
public class DrugLookupWindowAnnotation extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(DrugLookupWindowAnnotation.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected DrugLookupWindowAnnotation() {/* intentionally empty block */}
   ...
   */
  public DrugLookupWindowAnnotation(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public DrugLookupWindowAnnotation(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public DrugLookupWindowAnnotation(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
