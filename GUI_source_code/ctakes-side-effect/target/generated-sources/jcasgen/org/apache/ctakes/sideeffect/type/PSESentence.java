 ...
 * @generated */
public class PSESentence extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(PSESentence.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected PSESentence() {/* intentionally empty block */}
   ...
   */
  public PSESentence(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public PSESentence(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
